...
header("Content-Type:text/html; charset=UTF-8");
  header("Location:search.php?back=color");
//処理部
session_start();
...
for($i =1 ; $i<= $divNum ;$i++)
{
	...
	$sql = "insert into sitedescolor value(".$no.",'color".$i."','".$color[$i]."')";
...
<body>
	...
	<!-- こっからメイン部分 -->
		...
		<br /><br />
		<br /><br />
                     <a href="webTop.php">サイトを作る</a><br />
		<br /><br />
                        <a href="colorTop.php">さらに色を作る</a><br />
		<br /><br />
